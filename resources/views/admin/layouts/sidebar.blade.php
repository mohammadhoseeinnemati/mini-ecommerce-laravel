                                ...
                                <ul class="main-menu mx-0">
                                    ...
                                    <li class="slide active">
                                        <a href="{{route('admin.dashboard')}}"
                                           class="side-menu__item {{activeSidebarItem('admin.dashboard')}}">
                                    ...
                                    <li class="slide ">
                                        <a href="{{route('admin.users.index')}}"
                                           class="side-menu__item {{activeSidebarItem(['admin.users.index','admin.users.show','admin.users.edit'])}}">
                                    ...
                                    <li class="slide  ">
                                        <a href="{{route('admin.products.index')}}"
                                           class="side-menu__item {{activeSidebarItem(['admin.products.index','admin.products.show','admin.products.create','admin.products.edit'])}}">
